...
-- Script date 22/02/2022 13:14:56
...
(1, 100.00, 'Huevos', 0.50),
(2, 5000.00, 'Patata Semipreparada', 0.35),
(3, 2000.00, 'Sal', 33.50),
(4, 10000.00, 'Aceite', 43.00),
...
--
-- Table cocina.guarniciones does not contain any data (it is empty)

-- 
-- Dumping data for table platos
--
INSERT INTO platos VALUES
(1, 'Surtido de Ibéricos', 1, 7.30, 0.00),
...
--
-- Table cocina.productos_en_guarniciones does not contain any data (it is empty)
...
--
-- Table cocina.comandas does not contain any data (it is empty)
...
SELECT DISTINCT
  (new.cantidad * (SELECT
      precio_publico
    FROM platos
    WHERE platos.id = new.id_plato)) INTO precio
FROM comandas;
