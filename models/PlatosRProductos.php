...
/**
 * This is the model class for table "platos_r_productos".
 *
 * @property int $id
 ...
 */
class PlatosRProductos extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['id_plato', 'id_producto'], 'unique', 'targetAttribute' => ['id_plato', 'id_producto']],
