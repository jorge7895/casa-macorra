...
/**
 * This is the model class for table "productos_r_proveedores".
 *
 * @property int $id
 ...
 */
class ProductosRProveedores extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'productos_r_proveedores';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['id_producto', 'id_proveedor'], 'unique', 'targetAttribute' => ['id_producto', 'id_proveedor']],
